...
<div className=' mt-4 p-16 w-full max-auto'>
...
<input type='text'  placeholder='name *'  onChange={(e) => setName(e.target.value)} required className='w-3/4 p-2 border-1' />
</div>

<div className='form-group mt-3'>
<input type='text'  placeholder='Email *'  onChange={(e) => setEmail(e.target.value)} required className='w-3/4 p-2 border-1' />
</div>

<div className='form-group mt-3'>
<input type='text'  placeholder='password *'  onChange={(e) => setPassword(e.target.value)} required className='w-3/4 p-2 border-1' />
</div>
...
<div className='form-group mt-3'>
<b>Already have an account?</b><Link to={'/signin'}>Login Here</Link>
</div>
</form>
